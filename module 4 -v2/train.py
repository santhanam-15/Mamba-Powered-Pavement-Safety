...
POS_WEIGHT_STRATEGY = "extreme"  # "low", "medium", "high", "extreme" ← UPGRADED TO EXTREME
...
FOCAL_ALPHA = 0.30  # Weight of positive class (increased from 0.25)
FOCAL_GAMMA = 2.5   # Focusing parameter (increased from 2.0, more focus on hard examples)

THRESHOLD_CANDIDATES = tuple(round(x, 2) for x in torch.arange(0.15, 0.56, 0.05).tolist())  # Lowered range: 0.15-0.55
